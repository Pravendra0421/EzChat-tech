				...
				<div class=" my-auto pb-10 w-full">
					...
					>
						<div>
							...
							<!--{$i18n.t('Signing in to open WebUI', { WEBUI_NAME: $WEBUI_NAME })}-->
						</div>
						...
						<div class="mb-1">
							<div class=" text-2xl font-medium">
								{#if mode === 'signin'}
									...
									<!--{$i18n.t(`Sign in to Open WebUI`, { WEBUI_NAME: $WEBUI_NAME })}-->
								{:else}
									{$i18n.t(`Sign up to EZChat`, { WEBUI_NAME: $WEBUI_NAME })}
									<!--{$i18n.t(`Sign up to Open WebUI`, { WEBUI_NAME: $WEBUI_NAME })}-->
								{/if}
							</div>
